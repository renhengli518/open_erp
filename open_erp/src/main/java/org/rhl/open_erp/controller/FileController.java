package org.rhl.open_erp.controller;
...
import org.rhl.open_erp.service.FileService;
import org.rhl.open_erp.util.DownloadUtil;
import org.rhl.open_erp.util.JsonUtils;
...
public class FileController {
	...
	@Value("#{uploadProperties['upload.file.path']}")
	private String path;
